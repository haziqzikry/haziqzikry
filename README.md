...
## 🛠 Fun Stacks I've Used

- 𝗣𝗿𝗼𝗴𝗿𝗮𝗺𝗺𝗶𝗻𝗴 - Python (pandas, numpy, polars, pyarrow, pyiceberg, dask, etc..), PySpark, SQL
- 𝗗𝗮𝘁𝗮 𝗘𝗻𝗴𝗶𝗻𝗲𝗲𝗿𝗶𝗻𝗴 - Airflow, Spark, Kafka, Strimzi Kafka Operator, CDC with Debezium Apache Iceberg, Hive Tables, Oracle, Power BI
